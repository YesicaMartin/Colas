        ...
        do{
            try{
                ...
                switch(opcion){
                    ...
                    case 6://Mostrar tamaÃ±o de la cola  
                        JOptionPane.showMessageDialog(null, "El tamaÃ±o de la cola es: (" + cl.sizeCola()+ ")",
                        "Desencolado", JOptionPane.INFORMATION_MESSAGE);
                        break;
                    ...
                    case 9://Salir
                        JOptionPane.showMessageDialog(null, "AplicaciÃ³n de Colas finalizada", "Fin", JOptionPane.INFORMATION_MESSAGE);
                        break;
                        
                    default:
                        JOptionPane.showMessageDialog(null, "OpciÃ³n incorrecta", "Error", JOptionPane.INFORMATION_MESSAGE);
                }
                
            } 
            //Validacion para que acepte solo numeros
